#Cargaar los elementos necesarios para ultilizar los modulos de django
import os
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'holajeni.settings')
import django
django.setup()


#Scrpit para poblar la tabla product
